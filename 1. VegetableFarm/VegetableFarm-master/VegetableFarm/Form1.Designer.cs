namespace VegetableFarm
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.downSpeedButton = new System.Windows.Forms.Button();
			...
			this.timeLabel.Location = new System.Drawing.Point(631, 25);
			this.timeLabel.Name = "timeLabel";
			this.timeLabel.Size = new System.Drawing.Size(133, 24);
			...
			this.speedLabel.Location = new System.Drawing.Point(631, 57);
			this.speedLabel.Name = "speedLabel";
			this.speedLabel.Size = new System.Drawing.Size(121, 24);
			this.speedLabel.TabIndex = 2;
			this.speedLabel.Text = "Speed: x1.00";
			// 
			// upSpeedButton
			// 
			this.upSpeedButton.Image = ((System.Drawing.Image)(resources.GetObject("upSpeedButton.Image")));
			this.upSpeedButton.Location = new System.Drawing.Point(758, 57);
			this.upSpeedButton.Name = "upSpeedButton";
			this.upSpeedButton.Size = new System.Drawing.Size(32, 32);
			this.upSpeedButton.TabIndex = 3;
			this.upSpeedButton.UseVisualStyleBackColor = true;
			this.upSpeedButton.Click += new System.EventHandler(this.UpSpeedButton_Click);
			// 
			// downSpeedButton
			// 
			this.downSpeedButton.Image = ((System.Drawing.Image)(resources.GetObject("downSpeedButton.Image")));
			this.downSpeedButton.Location = new System.Drawing.Point(796, 57);
			this.downSpeedButton.Name = "downSpeedButton";
			this.downSpeedButton.Size = new System.Drawing.Size(32, 32);
			this.downSpeedButton.TabIndex = 4;
			this.downSpeedButton.UseVisualStyleBackColor = true;
			this.downSpeedButton.Click += new System.EventHandler(this.DownSpeedButton_Click);
			// 
			// moneyLabel
			// 
			...
			this.moneyLabel.Location = new System.Drawing.Point(631, 153);
			this.moneyLabel.Name = "moneyLabel";
			this.moneyLabel.Size = new System.Drawing.Size(108, 24);
			this.moneyLabel.TabIndex = 5;
			this.moneyLabel.Text = "Money: 50$";
			// 
			// Form1
			// 
			...
			this.Controls.Add(this.downSpeedButton);
			this.Controls.Add(this.upSpeedButton);
			this.Controls.Add(this.speedLabel);
			this.Controls.Add(this.timeLabel);
			this.Controls.Add(this.panel1);
			this.Name = "Form1";
			this.Text = "Vegetable Farm";
		...
		private System.Windows.Forms.Button downSpeedButton;
